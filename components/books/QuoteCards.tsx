...
export default function QuoteCards({ quotes, bookTitle }: { quotes: Quote[]; bookTitle: string }) {
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {quotes.map((q, i) => (
            <motion.div
              ...
              style={{ backgroundColor: 'var(--color-surface-card)' }}
            >
              <span className="text-3xl mb-4 opacity-30" style={{ color: 'var(--color-coral)', fontFamily: 'Georgia, serif', lineHeight: 1 }}>"</span>
              <blockquote
